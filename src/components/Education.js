      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          ...
          <Details
            ...
            time="2006"
            place="San Diego State University, CA"
            info="Completed required advanced courses for the Computer Science degree path."
          />
          <Details
            type="Bachelor of Science in Computer Science"
            time="2003"
            place="San Diego State University, CA"
            info="Completed required courses for the Computer Science degree path."
          />
        </ul>
      </div>
    </div>
