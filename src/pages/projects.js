...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Chris Warren | Projects Page</title>
        <meta
          name="description"
          content="Discover the latest projects created by Chris Warren, a Software engineer with 
        expertise in React, React Native and full-stack development."
        />
      </Head>
      ...
      >
        <Layout className="pt-16">
          <AnimatedText
            text="If you can imagine it, I can build it!"
